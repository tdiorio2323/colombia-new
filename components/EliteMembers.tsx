      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="font-bold text-white">
            {member.name} {member.countryFlag}
          </p>
          <p className="text-sm text-stone-400">
            Investment: <span className="text-brand-rose">{member.investment}</span>
          </p>
  ...
  return (
    <section className="py-20 px-4 bg-brand-dark-2">
      <div className="container mx-auto">
        <SectionTitle
          title="Elite Members"
          subtitle="Join the world's most distinguished luxury community"
        />
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="bg-brand-dark-2/50 border border-stone-700/50 rounded-2xl p-8 md:p-12 text-center hover:border-brand-rose/50 hover:shadow-glow transition-all duration-300">
            <h3 className="text-4xl font-serif font-bold bg-clip-text text-transparent bg-brand-gradient mb-3">
              Join the Elite
            </h3>
